...
namespace ATSoft
{
    public class FirebaseRemoteConfigManager
    {
        ...
        public static bool enableShowAOAOpenGame = true;
        ...
        public static void SetupDefaultConfigs()
        {
            ...
            {
                {FirebaseRemoteConfigKeys.ConfigAdCappingTime, 0},
                {FirebaseRemoteConfigKeys.ConfigIntersStartLevel, 2},
                {FirebaseRemoteConfigKeys.EnableShowAoaOpenGame, true},
                {FirebaseRemoteConfigKeys.ConfigPopupRateUsLevel, "5,10,15,20,25,30,35,40,45,50,55,60,65"},
            };
        ...
        private static void SetupRemoteConfigs(Task fetchTask)
        {
            ...
            interstitialCappingTime = (int)FirebaseRemoteConfig.DefaultInstance.GetValue(FirebaseRemoteConfigKeys.ConfigAdCappingTime).LongValue;
            interstitialStartLevel = (int)FirebaseRemoteConfig.DefaultInstance.GetValue(FirebaseRemoteConfigKeys.ConfigIntersStartLevel).LongValue;
            enableShowAOAOpenGame = FirebaseRemoteConfig.DefaultInstance.GetValue(FirebaseRemoteConfigKeys.EnableShowAoaOpenGame).BooleanValue;
            var popUpRateGame = FirebaseRemoteConfig.DefaultInstance.GetValue(FirebaseRemoteConfigKeys.ConfigPopupRateUsLevel).StringValue.Split(',');
