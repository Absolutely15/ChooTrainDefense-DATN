Shader "Simple Toon/SToon Outline"
{
	Properties
    {
        ...
        _GreyScaleEffector ("Grey Scale", Range(0,1)) = 0
    ...
    SubShader
    {
        ...
        Pass
        {
			...
			fixed4 frag (v2f i) : SV_Target
            {
				...
				postCol.a = 1.;
				float grey = dot(postCol.rgb, float3(0.3, 0.59, 0.11));
				
				postCol.rgb = ColorBlend(postCol, grey, _GreyScaleEffector);
